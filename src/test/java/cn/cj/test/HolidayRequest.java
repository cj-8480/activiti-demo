...
/**
 * @author he.ai aihehe123@gmail.com 使用场景： 功能描述：
 */
public class HolidayRequest {
	public static void main(String[] args) {
		...
		MongoClient mongoClient = new MongoClient(
				new MongoClientURI("mongodb://192.168.150.48:27017/flowable?ssl=false"));

		ProcessEngine processEngine = new MongoDbProcessEngineConfiguration().setMongoClient(mongoClient)
		...
		json.put("select", 1);
		taskService.setVariable(task.getId(), "TestVab", json);
